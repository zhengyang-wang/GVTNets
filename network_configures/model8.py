...
conf_unet['first_output_filters'] = 32
...
conf_unet['encoding_block_sizes'] = [1, 0, 0]
...
conf_unet['downsampling'] = ['down_res_block', 'down_res_block']
...
conf_unet['bottom_block'] = ['same_gto']
...
conf_unet['upsampling'] = ['transposed_convolution', 'transposed_convolution']
...
assert conf_unet['depth'] == len(conf_unet['upsampling']) + 1
