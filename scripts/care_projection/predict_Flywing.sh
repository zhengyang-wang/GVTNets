...
# Projection_Flywing.tar.gz downloaded from https://publications.mpi-cbg.de/publications-sites/7207/
# TEST_DATASET_DIR should refer to test_data.
TEST_DATASET_DIR="/mnt/dive/shared/yaochen.xie/CSBDeep/Projection_Flywing/test_data/"
