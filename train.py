...
def main(_):
	...
	parser.add_argument('--lr_decay_rate', type=float, default=1.0, help='learning rate decay rate')
	parser.add_argument('--lr_decay_steps', type=int, default=10000, help='learning rate decay rate')
